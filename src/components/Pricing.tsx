      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-gray-400">
            Acesso imediato e vitalício a todas as ferramentas com um pagamento único.
          </p>
        </div>
        ...
        <div className="mt-16 bg-gray-900/50 border-2 border-cyan-500 rounded-2xl shadow-2xl glow-shadow p-8 relative overflow-hidden">
          <div className="absolute -top-4 -right-4 bg-yellow-400 text-black font-bold py-2 px-6 transform rotate-45 translate-x-12 translate-y-3">
            MAIS POPULAR
          </div>
          <div className="text-center">
            ...
            <a
              ...
              className="w-full inline-block bg-gradient-to-r from-cyan-400 to-blue-600 text-white font-bold py-4 px-10 rounded-full hover:opacity-90 transition-transform transform hover:scale-105 shadow-lg shadow-cyan-500/40 text-xl"
            >
